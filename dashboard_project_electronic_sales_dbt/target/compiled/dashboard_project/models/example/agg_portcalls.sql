CREATE OR REPLACE TABLE `dashboardprojectelsales.dashboard_dataset.agg_portcalls` AS
        ...
        ON s.year = w.year AND s.country_code = w.country_code AND s.country = w.country